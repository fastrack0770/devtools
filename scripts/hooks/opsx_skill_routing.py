...
PROPOSE = ("[skill-routing] Planning phase (propose/explore): consider "
           ...
           "idea-refine / interview-me (if the spec is vague), "
           "doubt-driven-development (high stakes/irreversible).")
APPLY = ("[skill-routing] Implementation phase (apply): consider "
         "incremental-implementation (if editing >1 file), "
         "test-driven-development (logic/bug/behavior change), "
